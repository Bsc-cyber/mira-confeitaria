...
<aside class="menu-lateral">
    ...
    <nav class="links-navegacao">
        ...
        <!-- 1. Dashboard -->
        <a href="/teste/php/home.php" class="item-menu">
        ...
        <!-- 2. Clientes -->
        <a href="teste/php/clientes.php" class="item-menu">
            <span class="marcador-selecionado"></span>
        ...
        <!-- 4. Pedidos -->
        <a href="/teste/php/pedidos.php" class="item-menu">
            <span class="marcador-selecionado"></span>
        ...
        <!-- 6. Receitas -->
        <a href="/teste/php/receitas.php" class="item-menu">
            <span class="marcador-selecionado"></span>
        ...
        <a href="/teste/php/fornecedores.php" class="item-menu">
            <span class="marcador-selecionado"></span>
